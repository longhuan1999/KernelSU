...
build_from_image() {
	...
	$AVBTOOL add_hash_footer --partition_name boot --partition_size $((64 * 1024 * 1024)) --image boot.img --algorithm SHA256_RSA4096 --key ../kernel-build-tools/linux-x86/share/avb/testkey_rsa2048.pem
	...
	$AVBTOOL add_hash_footer --partition_name boot --partition_size $((64 * 1024 * 1024)) --image boot-gz.img --algorithm SHA256_RSA4096 --key ../kernel-build-tools/linux-x86/share/avb/testkey_rsa2048.pem
	...
	$AVBTOOL add_hash_footer --partition_name boot --partition_size $((64 * 1024 * 1024)) --image boot-lz4.img --algorithm SHA256_RSA4096 --key ../kernel-build-tools/linux-x86/share/avb/testkey_rsa2048.pem
